...
from cvmonitor.ocr.text_spotting.tracker import StaticIOUTracker
from cvmonitor.ocr.text_spotting.visualizer import Visualizer
...
if __name__ == '__main__':
    # -m_m cvmonitor/ocr/PreTrained/FP32//text-spotting-0001-detector.xml -m_te cvmonitor/ocr/PreTrained/FP32//text-spotting-0001-recognizer-encoder.xml -m_td cvmonitor/ocr/PreTrained/FP32//text-spotting-0001-recognizer-decoder.xml -i cvmonitor/test/data/11.jpg

    # -m_m cvmonitor/ocr/PreTrained/FP32//text-spotting-0001-detector.xml \
    # -m_te cvmonitor/ocr/PreTrained/FP32//text-spotting-0001-recognizer-encoder.xml \
    # -m_td cvmonitor/ocr/PreTrained/FP32//text-spotting-0001-recognizer-decoder.xml \
    # -i cvmonitor/test/data/11.jpg
    sys.exit(main() or 0)
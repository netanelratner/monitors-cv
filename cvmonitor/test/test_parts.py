...
def test_ocr_by_segments():
    image = imageio.imread(os.path.dirname(__file__)+'/data/cvmonitors-cvmonitor-9a6d4db29fa04bfa.jpg')
    segments = json.load(open(os.path.dirname(__file__)+'/data/cvmonitors-cvmonitor-9a6d4db29fa04bfa.json'))
    ...
    texts, boxes, scores, _ = text_spotting.forward(image, expected_boxes=expected_boxes)